<?php
/*
 * Plugin Name: CB Social Like Box
 * Description: Easy facebook like box in WordPress site. go to appearance>widget>use 'Social Like Widget'. 
 * Version: 1.1.2
...
class custom_widget_class extends WP_Widget{
	...
	public function __construct(){
		parent::__construct ('custom_widget_class', __('Social Like Widget', 'textdomain'), array('description' => __('This is facebook like box for only wordpress', 'textdomain')));
